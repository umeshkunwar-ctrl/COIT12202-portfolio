...
![mkpasswd and useradd generating the three hash types, and the resulting /etc/shadow entries](images/shadow-file-hashes.png)
...
![Backing up common-password and confirming the pam_pwquality line](images/pam-quality-config.png)
...
![The wired-in common-auth file with pam_faillock preauth/authfail/authsucc in the correct order](images/pam-faillock-config.png)
...
![Creating user_test and confirming its uid/gid after passwd succeeds](images/user-test-creation.png)
...
![Testing weak and compliant passwords against user_test, and confirming the pam_pwquality and pam_faillock lines](images/password-policy-test.png)
...
![Five failed su - user_test re-authentications from the user_test shell](images/lockout-test.png)
...
![Checking the faillock status for user_test after the failed attempts](images/faillock-status.png)
...
![John the Ripper cracking crack_md5, crack_sha512 and crack_yescrypt, with timing for each run](images/john-the-ripper-crack.png)
